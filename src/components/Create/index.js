      ...
      <div className="w-[95%] ml-auto mr-auto py-8 px-8 h-auto flex justify-evenly rounded">
          ...
          <form onSubmit={handleSubmit} className=" items-center">
            ...
            <div className="bg-black/35 w-[95%] py-1 ml-auto mr-auto rounded-3xl mt-3 text-white">
              ...
              <div className="w-[70%] ml-auto mr-auto text-center rounded-3xl h-7 bg-red-500/55">
                <p className="py-0.5">
                  We only accept .mp3 .wav .ogg files Innit{" "}
                </p>
              </div>
            </div>
        ...
        <div className="w-[30%] flex flex-col rounded-2xl bg-white/35 py-8 px-8">
          ...
          <div className={`mt-12 py-4 px-3 rounded-3xl`}>
            {artistName && (
              <div className="flex mt-2 mb-3  rounded-3xl bg-black/25 py-2 px-2">
                {" "}
                Artist Name: <p className="mr-2 ml-2"> {artistName}</p>{" "}
              </div>
            )}
            {name && (
              <div className="flex py-2 mt-3 nb3 rounded-3xl bg-black/25  px-2">
                {" "}
                Genre Name: <p className="mr-2 ml-2"> {name}</p>{" "}
              </div>
            )}
            {description && (
              <div className="flex mt-3 nb3 rounded-3xl bg-black/25  py-2 px-2">
                {" "}
                Description: <p className="mr-2 ml-2">{description}</p>{" "}
              </div>
            )}
            {price && (
              <div className="flex py-2  mt-3 nb3 rounded-3xl bg-black/25 px-2">
                {" "}
                Price: <p className="mr-2 ml-2">{price}</p> ETH
              </div>
            )}
          </div>
        </div>
